        ...
        cb_single.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cb_single.isChecked()) {
                    Toast.makeText(MainActivity.this, "Checker", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(MainActivity.this, "UnChecker", Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        switch (view.getId()) {
            case R.id.cb_addidas:
                if (checked)
                    ...
                    Toast.makeText(MainActivity.this, "Addida Removed",
                            Toast.LENGTH_SHORT).show();
                break;
            case R.id.cb_nike:
                if (checked)
                    ...
                    Toast.makeText(MainActivity.this, "Nike Removed",
                            Toast.LENGTH_SHORT).show();
                break;
        }
    }
